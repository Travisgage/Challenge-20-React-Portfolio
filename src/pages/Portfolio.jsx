...
/* import strictlyballroom from 'src/assets/strictly-ballroom.jpg';
import taskboard from 'src/assets/task-board.jpg';
import texteditor from 'src/assets/text-editor.png';
import notetaker from 'src/assets/note-taker.png';
import bestblog from 'src/assets/best-blog-ever.png';
import hsb from 'src/assets/hannah-smith-ballroom.jpg'; */
    ...
    <Flex justifyContent="center" flexDirection="column" m={{base: 2, md: 6}} p={{base: 4, md: 6}}>
      ...
      >
        <Image
          ...
          src={'src/assets/strictly-ballroom.jpg'}
      ...
      >
        <Image
          objectFit='cover'
          maxW={{ base: '100%', sm: '200px' }}
          src={'src/assets/hannah-smith-ballroom.jpg'}
      ...
      >
        <Image
          objectFit='cover'
          maxW={{ base: '100%', sm: '200px' }}
          src={'src/assets/text-editor.png'}
      ...
      >
        <Image
          objectFit='cover'
          maxW={{ base: '100%', sm: '200px' }}
          src={'src/assets/best-blog-ever.png'}
          alt='Best Blog Ever'
        />
        <Stack>
          <CardBody>
